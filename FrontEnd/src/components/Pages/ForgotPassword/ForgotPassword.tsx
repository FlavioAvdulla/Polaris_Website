        ...
        <div className="flex flex-col gap-10 p-5 h-auto rounded-xl bg-white
          ...
          <div className="flex w-[100%] h-auto items-center justify-between">
            <h1 className="font-camptonBook text-[20px] ml-5
                           dark:text-white">
            {t("authentication.resetPassword")}</h1>
          ...
          <div className="flex flex-col w-[100%] gap-2">
            ...
            <input
              className="w-[100%] h-[45px] rounded-full font-camptonLight
          ...
          <div className="flex flex-col gap-4">
            <button className="flex items-center justify-center border-primary border-[1px] text-white
                               text-[17px] w-[100%] h-[45px] bg-primary rounded-full duration-300
              ...
              <p className="ml-2 xs:text-[12px] md:text-[16px] font-camptonBook
                            dark:text-white">{t("authentication.resetPassword")}</p>
            </button>
            <p className="font-camptonBook ml-5
                          dark:text-white">{t("authentication.goBackTo")}{" "}
              <button className="text-primary
                                 dark:text-secondary_01"
                      onClick={handleSignInOpen}>{t("authentication.signIn")}
              </button>{" "}
              {t("authentication.or2")}{" "}
              <button className="text-primary
                                 dark:text-secondary_01"
                      onClick={handleRegisterOpen}>{t("authentication.signup")}
              </button>.
            </p>
          </div>
        </div>
