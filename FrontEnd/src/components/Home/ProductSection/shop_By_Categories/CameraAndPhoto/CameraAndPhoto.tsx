...
export const featuredCameraAndPhotoProductIdsLength = featuredProductIds.length
    ...
    <div className="w-[85%] flex flex-col mx-auto">
      ...
      <div className="flex w-[100%] justify-between items-center mb-7">
        <h1 className="font-camptonMedium
                       ...
                       sm:text-[11px]
                       md:text-[15px]
                       lg:text-[22px]">{t("cameraAndPhoto.cameraAndPhotoTitle")}</h1>
